# Exercícios: C# - Estrutura Condicional e de Repetição

**1 -** Faça um algoritmo em C# para calcular a média aritmética das 3 notas de um
...
**2 -** Elaborar um algoritmo em C# que dado 3 valores A, B, C, exiba no console o
maior dos 3 valores e com a mensagem: "É o maior ".

**3 -** Elaborar um algoritmo em C# que dado 2 valores A e B e os exibam no console
...
**5 -** Elaborar um algoritmo em C# que dado dois valores e exiba no console uma das
três mensagens a seguir:
‘Números iguais’, caso os números sejam iguais
‘Primeiro é maior’, caso o primeiro seja maior que o segundo
‘Segundo maior’, caso o segundo seja maior que o primeiro.

**6 -** Elaborar um algoritmo em C# para calcular o IMC ideal de uma pessoa. Tendo
...
**7 -** Escreva um algoritmo em C# para exibir no console os números de 1 (inclusive) a
10 (inclusive) em ordem decrescente.

**8 -** Escreva um algoritmo em C# para exibir no console os números múltiplos de 5 do
intervalo de 1 a 50.
...
10 - Escreva um algoritmo em C# que dado um número inteiro N exiba no console
todos os valores pares entre 1 (inclusive) e N (inclusive). Considere que o N será sempre
maior que ZERO.

11 – Escreva um algoritmo em C# que calcule e exiba no console a tabuada do 7
...
15 - Escreva um algoritmo em C# que exiba no console os 15 primeiros números da
