# Exercícios: Vetores e Funções

**1 -** Crie um algoritmo que gere um vetor de 8 posições, onde os valores de
...
Crie um algoritmo que gere um vetor V2 a partir do dobro de cada valor de V.
