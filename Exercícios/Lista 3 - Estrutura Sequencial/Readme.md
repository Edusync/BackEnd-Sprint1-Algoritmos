# Exercícios: C# - Estrutura Sequencial

**1 -** Escreva um algoritmo em C# que dado (atribuição) três números inteiros e
positivos (A, B, C) e calcule a seguinte expressão: X = A + B / C. Exiba o resultado no console.

**2 -** Faça um algoritmo em C# que dada (atribuição) as 3 notas de um aluno, calcule
...
**3 -** Faça um algoritmo em C# que dado (atribuição) o tempo de duração de um evento
em uma fábrica expressa em segundos e mostre o resultado no console expresso em horas,
minutos e segundos.

**4 -** Escreva um algoritmo em C# que calcule a área de um triângulo equilátero.

**5 -** Escreva um algoritmo em C# que dado (atribuição) três números inteiros e positivos
(A, B, C) e calcule a seguinte expressão: X = (A + B)² + C. Exiba o resultado no console.
**Exemplo**:
*A* = 2,  *B* = 2,  *C* = 4,  *Resultado*: X = 20

**6 -** Escreva um algoritmo em C# que dado um valor escreva no console o dobro de
seu antecessor.
**Exemplo**:
*Fornecendo o valor* 3,     *Resultado*: 4

**7 -** Escreva um algoritmo em C# que dado o número total de eleitores de um município,
...
do distribuidor seja de 30% e os impostos de 45%, escrever um algoritmo em C# que
dado (atribuição) o custo de fábrica de um carro e escreva, no console o custo ao consumidor.

**9 –** Escreva um algoritmo em C# capaz de calcular as raízes de uma equação de
